...
import co.herxun.impp.activity.LocationActivity;
import co.herxun.impp.activity.WallActivity;
import co.herxun.impp.activity.EventActivity;
...
public class ExploreFragment extends BaseFragment {
	...
	private void initView(View fragView,Context ct){
        ...
        fragView.findViewById(R.id.explore_btn_wall1).setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				likeCount = 0;
				wallBadge.setBadgeCount(0);
